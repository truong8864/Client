...
import ToChucPhongBan from "../ToChucNhanSu/ToChucPhongBan";
import DanhSachPhongBan from "../ToChucNhanSu/DanhSachPhongBan";

import ChiTietNhanVien from "../ChiTietNhanVien";

import DanhSachNhanVien from "../DuLieuNhanVien/DanhSachNhanVien";
import NhanVienNghiViec from "../DuLieuNhanVien/NhanVienNghiViec";
import NhanVienNghiHuu from "../DuLieuNhanVien/NhanVienNghiHuu";
import TrinhDoChuyenMon from "../DuLieuNhanVien/TrinhDoChuyenMon";
import NguoiThan from "../DuLieuNhanVien/NguoiThan";
...
const routes = [
  ...
  },
  {
    ...
    component: ToChucPhongBan,
  },
  {
    path: "/nhan-su/to-chuc-nhan-su/danh-sach-phong-ban",
    exact: true,
    name: "Danh sách phòng ban",
    component: DanhSachPhongBan,
  },
  {
    path: "/nhan-su/to-chuc-nhan-su/to-chuc-phong-ban",
    exact: true,
  ...
  },
  {
    ...
    component: NhanVienNghiViec,
  },
  {
    path: "/nhan-su/du-lieu-nhan-vien/nhan-vien-nghi-huu",
    exact: true,
    name: "Danh sách nghỉ hưu",
    component: NhanVienNghiHuu,
  },
  {
    path: "/nhan-su/du-lieu-nhan-vien/trinh-do-chuyen-mon",
    exact: true,
    name: "Danh sách nghỉ hưu",
    component: TrinhDoChuyenMon,
  },
  {
    path: "/nhan-su/du-lieu-nhan-vien/nguoi-than",
    exact: true,
    name: "Danh sách nghỉ hưu",
    component: NguoiThan,
  },
